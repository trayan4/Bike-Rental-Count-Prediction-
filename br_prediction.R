...
#Then, I'll check the relation between target variable & categorical independent variables
...
#lets take a known value & convert it to na, then I'll impute the same using diff. techniques
...
#So, we can't conclude from the test results about which categorical variables I should remove.
